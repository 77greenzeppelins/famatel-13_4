...
export const metadataText = {
  ...
  cat4: {
    ...
    keywords: [
      'gniazda podwieszane',
      'gniazda na linie produkcyjne',
      'gniazda wielostronne',
    ],
  },
  cat5: {
  ...
  cat6: {
    ...
    keywords: [
      ...
      'Rozłączniki bezpieczeństwa dla gastronomii',
    ],
  },
  cat7: {
    ...
    keywords: [
      ...
      'Ekologiczne ładowarki samochodowe',
    ],
  },
  cat8: {
