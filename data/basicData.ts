import { mainPagesPaths, mainPagesLabels, mainCategoriesNames } from './routingData';
...
export const doPobraniaPageData = {
    ...
    declarationsData: [
        {
            id: '01',
            label: 'Deklaracja zgodności wyrobów o numerach katalogowych 3952.XXXX (IP44, IP65 stacjonarne i przenośne)',
        ...
        {
            id: '02',
            label: 'Deklaracja zgodności wyrobów o numerach katalogowych 3957.XXXX (IP44, IP65 stacjonarne i przenośne)',
        ...
        {
            id: '03',
            label: 'Deklaracja zgodności wyrobów o numerach katalogowych 3958.XXXX (IP44, IP65 stacjonarne i przenośne)',
        ...
        {
            id: '04',
            label: 'Deklaracja zgodności wyrobów o numerach katalogowych 3959.XXXX (IP44, IP65 stacjonarne i przenośne)',
        ...
        {
            id: '05',
            label: 'Deklaracja zgodności wyrobów o numerach katalogowych 3977.XXXX (IP44, IP65 stacjonarne i przenośne)',
