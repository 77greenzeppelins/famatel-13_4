...
/**-------------------------------------------------------**/
const DraggableSlider = memo(function DraggableSlider({ axis, axisSize, currentCategory }: Props) {
    /**References**/
  ...
  */
    const slideSide = axisSize > minAxisSizeForLargeCell ? largeCellSize : smallCellSize;
    const minNumberOfSlides = Math.trunc(Math.min(axisSize, sliderMaxWidth) / slideSide + slidesNumberOffset);
    ...
    return (
        <div
            ...
            ref={constraintsRef}
            className="relative h-full overflow-hidden rounded-lg fc w-fit hover:cursor-grabbing"
            /*
