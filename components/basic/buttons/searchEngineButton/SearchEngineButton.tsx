...
/**---------------------------------**/
const SearchEngineButton = ({ setIsOverlay, setContentType, contentType, isOverlay }: Props) => {
    /**...**/
  ...
  */
    ...
    const conditionDisable = contentType !== headerSpecButtons.searchEngine && isOverlay;

    /**JSX**/
    return (
        <div
            className={`w-10 h-10 ${
                condition ? 'border fc border-corpo duration-300 ease-linear' : styleCondition ? 'border fc border-dark duration-300 ease-linear' : 'border fc border-grey duration-300 ease-linear'
            }`}
        >
            <button
                disabled={isDisabled}
            ...
            >
                <MagGlassIcon
                    ...
                    pathStyle={styleCondition ? 'stroke-grey duration-300 ease-linear' : 'stroke-dark duration-300 ease-linear'}
                    strokeWidth={1.5}
                />
            </button>
        </div>
