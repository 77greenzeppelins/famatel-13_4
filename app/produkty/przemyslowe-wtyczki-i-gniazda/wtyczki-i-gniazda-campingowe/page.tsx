...
export const metadata: Metadata = {
    title: { absolute: metadataText.cat1.subCat9.title },
    description: metadataText.cat1.subCat9.description,
    keywords: metadataText.cat1.subCat9.keywords,
    alternates: {
        canonical: metadataText.cat1.subCat9.canonical
    }
};
