...
export const indexImgCat: ImageType_C[] = [
  ...
  {
    path: '/images/for_dropDownMenu/2_gniazda_z_blokada.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/3_adaptery-przemyslowe.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/4_gniazda-podwieszane.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/5_przedluzacze-bebnowe.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/6_safety-switch.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/7_ladowarki.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/8_obudowy.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/9_rozdzielnice.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
  {
    path: '/images/for_dropDownMenu/10_puszki-polaczeniowe_scale.webp',
    width: 400,
    height: 400,
    alt: 'Zdjęcie wtyczki przemysłowej',
  },
